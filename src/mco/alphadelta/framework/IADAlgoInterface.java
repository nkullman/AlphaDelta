...
public interface IADAlgoInterface {
    ...
    /**
     * Gets and returns the user's desired destination for output generated by the alpha-delta algorithm
     * @return
     */
    File getOutputDestination();
    /**
     * Assigns a directory for the files produced during the execution of the alpha-delta algorithm
     * @param outputDestination the path where the output of the algorithm will be stored
     */
    void setOutputDestination(File outputDestination);
}